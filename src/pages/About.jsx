      ...
      <div className="max-w-4xl mx-auto py-16 px-4">
        <div className="grid md:grid-cols-3 gap-10 items-start">
          <div className="md:col-span-2">
            ...
            <p className="text-slate-600 leading-relaxed mb-4">Yeukai Kajidori began her career working directly with vulnerable young people in residential care. Over the next two decades, she rose through every level of health and social care leadership — from Financial Manager to Operations Director to CQC Registered Healthcare Operations Manager — building an unbroken track record of compliance, growth, and cultural transformation.</p>
            <p className="text-slate-600 leading-relaxed mb-4">She has registered organisations with the CQC from scratch. She has turned Requires Improvement services into Good-rated ones. She has doubled revenue, opened new facilities, recruited and developed high-performing teams, and secured millions of pounds in local authority contracts. Every service she has led has been better for her involvement.</p>
